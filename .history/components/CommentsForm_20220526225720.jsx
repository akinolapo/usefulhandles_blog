...
const CommentsForm = ({slug}) => {
  ...
  return (
    <div className='bg-white shadow-lg rounded-lg p-8 pb-12 mb-8'>
      ...
      <div className="mt-8">
        <button className='transition duration-500 ease hover:bg-indigo-900 inline-block bg-pink-600 text-lg rounded-full text-white px-8 py-3 cur' type='button' onClick={handleCommentSubmission}>Post Comment</button>
      </div>
