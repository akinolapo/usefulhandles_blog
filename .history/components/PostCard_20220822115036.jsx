  ...
  return (
    <div className='bg-white shadow-lg rounded-lg p-0 lg:p-8 pb-12 mb-8'>
      ...
      <div className="text-center">
        <Link href={`/post/${post.slug}`}>
          <span className='transition duration-500 transform hover:-translate-y-1 cursor-pointer inline-block bg-pink-600 text-lg font-md rounded-full text-white px-8 py-0'>Contine Reading</span>
        </Link>
      </div>
    </div>
  )
